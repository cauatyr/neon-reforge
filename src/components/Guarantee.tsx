    ...
    <section className="py-20 px-4 relative">
      <div className="container mx-auto max-w-4xl">
        <div className="glass-card p-8 md:p-12 rounded-2xl text-center space-y-8 animate-fade-in-up border-2 border-automotive-bronze shadow-[0_0_40px_rgba(139,92,46,0.3)]">
          ...
          <h2 className="lambo-section-title text-3xl md:text-4xl font-bold">
            Garantia Incondicional de <span className="text-automotive-bronze text-glow-bronze">30 Dias</span>
          </h2>

          <div className="space-y-4">
            <h3 className="lambo-text-cascade text-2xl font-semibold text-automotive-bronze">
              100% Sem Riscos
            </h3>
            <p className="lambo-text-cascade text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            <p className="lambo-text-cascade text-xl font-semibold text-foreground">
